...
test('If the starting price of the old car is greater than that of the new, the savings profit is returned', () => {
...
test('Returns the savingsPlanner result as an array of two values', () => {
    ...
    expect(savingsPlanner(1000, 8000, 1000, 1.5)).toEqual([7, 1077]);
});
